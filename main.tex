...
\end{tikzpicture}
\caption{A top-down diagram of a dipole illustrating how small changes in the beam's position, $x$, are amplified by the bending effect of the magnet.}\label{fig:dipole_error}
\end{figure}
