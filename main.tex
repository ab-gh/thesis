...
\end{abstract}
\vspace*{\fill}
\keywords{Beam Physics, Slow Extraction, Radio-Frequency Knockout, Simulation, Xsuite}
\vspace*{\fill}
\newpage
%\setcounter{page}{1}
...
These two methods can be compared using a Stienbach diagram
