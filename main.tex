...
\begin{itemize}
  ...
  \item The \textit{Xi’an Proton Application Facility} (XiPAF) uses \textit{Radio-Frequency Knock Out} (RFKO) extraction~\cite{Yao:2016cnf}, an amplitude-driven method which transversely ``heats'' (excites) the beam, increasing emittance and amplitude into unstable regions.
\end{itemize}
