...
\begin{equation}
  \frac{2\pi\rho}{v_s}=\frac h\omega
\end{equation} where $\omega$ is the particle revolution frequency, and $h$ is the RF harmonic, the number of RF cycles per revolution. For East Area beams in the PS, $h=8$ acceleration is used. This means that there are eight stable ``particles'', spread equidistantly around the ring circumference.
