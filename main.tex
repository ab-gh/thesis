...
\subsubsection{COSE}
To combat this effect, \textit{Constant-Optics Slow Extraction} (COSE) employs techniques of both betatron core and tune-sweep: the momentum rigidity of the beam, $B\rho$, is increased simultaneously with the tune-sweep.
