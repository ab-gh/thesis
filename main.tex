...
\begin{center}
  ...
  \begin{table}[]
    ...
    \end{tabular}
    \caption{Table of configured high-level parameters for the implementation of the East Area RFKO slow extraction.}\label{tab:params}
    \end{table}
\end{center}
