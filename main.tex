...
These effects can be analysed by, again, considering phase space coordinates---this time in the longitudinal plane. 
...
\centering
  ...
  % Text Node
  \draw (141,119) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \phi _{s}$};
  % Text Node
  \draw (332,120) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \pi -\phi _{s}$};
  % Text Node
...
\draw   (271,138) .. controls (271,118.67) and (295.62,103) .. (326,103) .. controls (356.38,103) and (381,118.67) .. (381,138) .. controls (381,157.33) and (356.38,173) .. (326,173) .. controls (295.62,173) and (271,157.33) .. (271,138) -- cycle ;
%Shape: Ellipse [id:dp42298450906410845] 
\draw   (221,138) .. controls (221,102.1) and (268.01,73) .. (326,73) .. controls (383.99,73) and (431,102.1) .. (431,138) .. controls (431,173.9) and (383.99,203) .. (326,203) .. controls (268.01,203) and (221,173.9) .. (221,138) -- cycle ;
%Curve Lines [id:da9789801876882891] 
\draw [line width=1.5]    (133.57,137.04) .. controls (179.8,100.6) and (246.8,53.6) .. (321,53) ;
%Curve Lines [id:da13655808869822939] 
\draw [line width=1.5]    (133.57,137.04) .. controls (88.8,175.6) and (64.8,198.6) .. (31,213) ;
%Curve Lines [id:da8042891125924323] 
\draw [line width=1.5]    (501,138) .. controls (464.8,101.6) and (403.8,53.6) .. (321,53) ;
%Curve Lines [id:da5506874788137697] 
\draw [line width=1.5]    (501,138) .. controls (510.8,147.6) and (518.8,155.6) .. (531,163) ;

%Curve Lines [id:da7022957081327477] 
\draw [line width=1.5]    (133.57,137.96) .. controls (179.8,174.4) and (246.8,221.4) .. (321,222) ;
%Curve Lines [id:da923029544743244] 
\draw [line width=1.5]    (133.57,137.96) .. controls (88.8,99.4) and (64.8,76.4) .. (31,62) ;
%Curve Lines [id:da7237658383284393] 
\draw [line width=1.5]    (501,137) .. controls (464.8,173.4) and (403.8,221.4) .. (321,222) ;
%Curve Lines [id:da8228274023420452] 
\draw [line width=1.5]    (501,137) .. controls (510.8,127.4) and (518.8,119.4) .. (531,112) ;

%Shape: Circle [id:dp7206380160494676] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (321,138) .. controls (321,135.24) and (323.24,133) .. (326,133) .. controls (328.76,133) and (331,135.24) .. (331,138) .. controls (331,140.76) and (328.76,143) .. (326,143) .. controls (323.24,143) and (321,140.76) .. (321,138) -- cycle ;
%Shape: Circle [id:dp4946649169960704] 
\draw   (391,90) .. controls (391,87.24) and (393.24,85) .. (396,85) .. controls (398.76,85) and (401,87.24) .. (401,90) .. controls (401,92.76) and (398.76,95) .. (396,95) .. controls (393.24,95) and (391,92.76) .. (391,90) -- cycle ;
%Shape: Circle [id:dp3701340668351334] 
\draw   (128,118) .. controls (128,115.24) and (130.24,113) .. (133,113) .. controls (135.76,113) and (138,115.24) .. (138,118) .. controls (138,120.76) and (135.76,123) .. (133,123) .. controls (130.24,123) and (128,120.76) .. (128,118) -- cycle ;
%Straight Lines [id:da8814571161987692] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (167.2,78.6) -- (145.42,107.01) ;
\draw [shift={(144.2,108.6)}, rotate = 307.48] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da4939647425580147] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (450.2,59.6) -- (405.96,83.64) ;
\draw [shift={(404.2,84.6)}, rotate = 331.48] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

% Text Node
\draw (145,56) node [anchor=north west][inner sep=0.75pt]   [align=left] {Unstable};
% Text Node
...
% Text Node
\draw (339,114.4) node [anchor=north west][inner sep=0.75pt]    {$\phi _{s}$};
% Text Node
\draw (164,203) node [anchor=north west][inner sep=0.75pt]   [align=left] {Separatrix};
...
\begin{enumerate}
    \item{Stable synchronous particle phase above and below transition energy}
    \item \todo{Longitudinal Emittance, bucket, acceptance}
    \item \todo{Tomography and Tomoscope}
    \item \todo{Long tune = synchrotron tune}
\end{enumerate}
