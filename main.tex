...
% [TODO) ========================================================== %
% I recommend you shorten this part to discuss only discuss RFKO.   %
% There are just too many method, some which don't accelerate       %
% the beam in any way                                               %
% ==================================================================%
...
% vvvvvvvv [TODO) Probably Don't Need This Table  vvvvvvv
% \begin{center}
%   \centering
%   \begin{table}[]
%     \centering
...
\begin{figure}
  \centering
    ...
    \draw   (21,99) -- (193,99) -- (193,128) -- (21,128) -- cycle ;
    %Shape: Rectangle [id:dp7642379398785082] 
    \draw   (21,139) -- (132,139) -- (132,165) -- (21,165) -- cycle ;
    %Flowchart: Process [id:dp6525347157854502] 
    \draw   (230,310) -- (481,310) -- (481,462) -- (230,462) -- cycle ;
    %Shape: Rectangle [id:dp11017046539363262] 
    \draw   (243,342) -- (467,342) -- (467,371) -- (243,371) -- cycle ;
    %Shape: Rectangle [id:dp4979424465747375] 
    \draw   (243,382) -- (464,382) -- (464,411) -- (243,411) -- cycle ;
    %Shape: Rectangle [id:dp6592088940340548] 
    \draw   (243,422) -- (297,422) -- (297,451) -- (243,451) -- cycle ;
    ...
    %Bend Arrow [id:dp8843271122457683] 
    \draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (262,451) -- (262,461.48) .. controls (262,467.57) and (266.93,472.5) .. (273.02,472.5) -- (475.5,472.5) -- (475.5,480) -- (490,466.5) -- (475.5,453) -- (475.5,460.5) -- (274,460.5) .. controls (274,460.5) and (274,460.5) .. (274,460.5) -- (274,451) -- cycle ;
    ...
    \draw   (220,298) .. controls (220,288.06) and (228.06,280) .. (238,280) -- (502,280) .. controls (511.94,280) and (520,288.06) .. (520,298) -- (520,472) .. controls (520,481.94) and (511.94,490) .. (502,490) -- (238,490) .. controls (228.06,490) and (220,481.94) .. (220,472) -- cycle ;
    %Flowchart: Data [id:dp12022932129321529] 
    \draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (512.56,421) -- (632,421) -- (604.44,480) -- (485,480) -- cycle ;
    %Bend Arrow [id:dp5368424116868331] 
    \draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (330,237) -- (368.36,237) .. controls (375.49,237) and (381.26,242.78) .. (381.26,249.9) -- (381.26,258.5) -- (385.56,258.5) -- (374.81,280) -- (364.06,258.5) -- (368.36,258.5) -- (368.36,249.9) .. controls (368.36,249.9) and (368.36,249.9) .. (368.36,249.9) -- (330,249.9) -- cycle ;
    %Bend Arrow [id:dp3452563524807608] 
    \draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (291.64,237) -- (330,237) .. controls (337.12,237) and (342.9,242.78) .. (342.9,249.9) -- (342.9,258.5) -- (347.2,258.5) -- (336.45,280) -- (325.7,258.5) -- (330,258.5) -- (330,249.9) .. controls (330,249.9) and (330,249.9) .. (330,249.9) -- (291.64,249.9) -- cycle ;
    %Bend Arrow [id:dp47460506979421724] 
    \draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (260,237) -- (291.64,237) .. controls (298.76,237) and (304.54,242.78) .. (304.54,249.9) -- (304.54,258.5) -- (308.84,258.5) -- (298.09,280) -- (287.34,258.5) -- (291.64,258.5) -- (291.64,249.9) .. controls (291.64,249.9) and (291.64,249.9) .. (291.64,249.9) -- (260,249.9) -- cycle ;
    %Right Arrow [id:dp14885018643483505] 
    \draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (265,230) -- (265,258.74) -- (270,258.74) -- (260,277.9) -- (250,258.74) -- (255,258.74) -- (255,230) -- cycle ;
    ...
    % Text Node
    \draw (32,105.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {flatten and match tune};
    % Text Node
    \draw (31,143.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {thin elements};
    % Text Node
    \draw (237,318) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textbf{Xsuite}};
    % Text Node
    \draw (250,348.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {generate and match distribution};
    % Text Node
    \draw (254,387.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {add septum aperture, TFB, RF};
    % Text Node
    \draw (254,428.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {track};
    % Text Node
    \draw (516,431.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{59.41pt}\setlength\topsep{0pt}
    \begin{center}
...
In order to compare the advantages of GPU acceleration provided by \verb|Xsuite|, the simulation processe described in~\autoref{sec:sim_process} was implemented and run on both a CPU context and CUDA GPU context using CERN's batch processing service. Simulations were run for a range of numbers of particles and turns, and both the CPU and real-time (\textit{wall-clock}) duration of the simulation was recorded. These results are presented in~\autoref{fig:cpu_graph_per_turn} and~\autoref{fig:gpu_graph_per_turn}. The number of particles in a simulation---$N_p$---effectively controls the computational intensity, as it determines the number of calculations which must be performed per iteration (turn). The number of turns---$N_t$---controls the number of iterations, and is therefore used to normalise computation time between simulation runs.

These figures show significantly different dependancy of simulation time on the operational intensity between CPU and GPU workloads. For CPU tasks there is no parallelism available, so for $N_p>10^2$---where performance isn't dominated by constant-time \textit{overhead} processes---performance is dependant on $N_p$.

For GPU tasks, however, there is a significant inital overhead process of allocating and transferring memory from the CPU to GPU. This is apparent from the stratification of performance (time per turn) in~\autoref{fig:gpu_graph_per_turn}. The performance, however, is not dependent on $N_p$ for $N_p<10^6$, where the performance is dominated by the constant-time parallelism available.
...
\begin{figure}
  ...
  \caption{\textit{Wall-clock} simulation time (s) per turn for CPU workload per turn as a function of number of particles. Line color indicates number of turns simulated.}\label{fig:cpu_graph_per_turn}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics*[width=0.7\linewidth]{GPU_graph_per_turn.png}
  \caption{\textit{Wall-clock} simulation time (s) per turn for GPU workload per turn as a function of number of particles. Line color indicates number of turns simulated.}\label{fig:gpu_graph_per_turn}
\end{figure}
...
%1 hour 19 minutes (\qty{4742}{\second}) for \qty{31622}{turns} and \qty{1000000}{particles}. 


This is an order of magnitude faster than previous work, for the same order of magnitude of turns, and two orders of magnitude more particles. This allows for significantly higher resolution simulations to be performed in a reasonable amount of time: 1 million particles were simulated over \qty{10000}{turns} in just 1 hour 13 minutes (\qty{4397}{\second}).
...
% [TODO) Talk about scripts for automated data taking, NXCALS, re-use some IPAC things
...
% [TODO) Still waiting on sim_rf_off
...
% [TODO) explain the consequences of these graphs
