...
%% REMOVE BEFORE SUBMISSION
 \usepackage[angle=0, fontsize=0.04\paperwidth, vpos=0.027\paperheight, color=gray, text=DRAFT\ Aug\ 23]{draftwatermark}
%% ========================
% BUG
...
\onehalfspacing
\begin{document}
\newgeometry{left=3cm,right=3cm,top=2cm,bottom=1cm}
\input{./titlepage.tex}
\restoregeometry
\newpage
